...
export const VoiceRecorder = ({ onRecordingComplete, onSendToApi }: VoiceRecorderProps) => {
  ...
  const { isRecording, recordingTime, startRecording, stopRecording } = useVoiceRecorder(handleComplete)
